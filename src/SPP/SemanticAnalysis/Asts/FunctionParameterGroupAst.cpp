...
module spp.semantic_analysis.asts.function_parameter_group_ast;


SPP::SemanticAnalysis::Asts::FunctionParameterGroupAst::FunctionParameterGroupAst(
...
SPP::SemanticAnalysis::Asts::FunctionParameterGroupAst::~FunctionParameterGroupAst() = default;

auto SPP::SemanticAnalysis::Asts::FunctionParameterGroupAst::print(Meta::AstPrinter &printer) const -> std::string {
