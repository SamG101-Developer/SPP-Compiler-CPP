...
module spp.semantic_analysis.asts.pattern_variant_destructure_object_ast;
import spp.semantic_analysis.asts.token_ast;


SPP::SemanticAnalysis::Asts::PatternVariantDestructureObjectAst::PatternVariantDestructureObjectAst(
...
SPP::SemanticAnalysis::Asts::PatternVariantDestructureObjectAst::~PatternVariantDestructureObjectAst() = default;

auto SPP::SemanticAnalysis::Asts::PatternVariantDestructureObjectAst::print(Meta::AstPrinter &printer) const -> std::string {
